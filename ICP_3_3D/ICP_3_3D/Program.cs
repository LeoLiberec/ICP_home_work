...
namespace ICP_3_3D
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            window = new RenderWindow(new VideoMode(800, 600), "ICP_3_3D Texture, Shaders, Barva, Object, Kamera");
            ...
            perspective = new Perspective(window.Size.X, window.Size.Y, 60, 1, 1000); // Angle - 60 stupnu
            ...
            transform3D.rotation = new Vector3f(90, 180, 1); // nesmime porit 0 -> 0 * neco = 0
            transform3D.scale = new Vector3f(2f, 2f, 2f); // nesmime porit 0 -> 0 * neco = 0
            ...
            Texture2D texture = new Texture2D("D://ICP//ICP_CV//ICP_3_3D//ICP_3_3D//bin//Debug//img.jpg");
